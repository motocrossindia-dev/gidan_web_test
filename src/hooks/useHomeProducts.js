...
const fetchHomeProducts = async (accessToken, filters = {}) => {
  ...
  const url = `${process.env.NEXT_PUBLIC_API_URL}${filters.flag ? '/product/public-products/' : '/filters/main_productsFilter/'}?${queryParams.toString()}&page_size=20&limit=20&page=1`;
