...
import GDCoins from './views/utilities/Wallet/BTcoins';
import GDCoinsHistory from './views/utilities/Wallet/BTCoinsHistory';
...
const DesktopRoutes = () => (
    <Routes>
      <Route path="/" element={<LandingPageLayout />}>
        ...
        {/* OLD ROUTES - Backward compatibility redirects */}
        ...
        <Route path="btcoins" element={<GDCoins />} />
        <Route path="history" element={<GDCoinsHistory />} />
        ...
        <Route path=":categorySlug/" element={<PlantFilter />} />
        <Route path=":categorySlug/:subcategorySlug/" element={<PlantFilter />} />
        <Route path=":categorySlug/:subcategorySlug/:productSlug/" element={<ProductData />} /> {/* Always 3-segment for products */}
      </Route>
