...
const TrendingCard = ({ name, price, imageUrl, product, userRating, inWishlist, inCart, getProducts, ratingNumber, mrp }) => {
  ...
  return (
    ...
    <div className="relative rounded-lg flex justify-center items-center w-full">
              <img name=" "   
                className="w-40 h-43 sm:w-48 sm:h-53 lg:h-[260px] object-cover mt-4 lg:w-[226px] object-contain transition-transform duration-300 rounded-[2rem] scale-100 hover:scale-105"
          ...
          <div className="relative w-full flex flex-col items-center p-2">
            ...
            <div className="flex flex-col items-center justify-center p-2 w-full text-center gap-2">
              ...
              <Typography sx={{ typography: { xs: "caption", md: "subtitle2" } }}>
                {product.name.length > 15 ? `${product.name.slice(0, 8)}...` : product.name}
              </Typography>


              {/* Price Section */}
              <div className="flex flex-col items-center justify-center mt-1">
                <p className="text-xs font-medium text-black">₹{Math.round(price)}</p>
                {/* {product.mrp && (
                  <p className="text-[10px] text-gray-400 line-through">₹{product.mrp}.00</p>
                )} */}
              </div>
            </div>
