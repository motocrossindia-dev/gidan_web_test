...
import NormalProductGrid from "../Shared/NormalProductGrid";
...
const TrendingSection = () => {
  ...
  const filteredProducts = useMemo(() => {
    ...
    // Limit to 3 rows: 12 products on desktop (3 rows × 4 columns), 6 on mobile (3 rows × 2 columns)
    const maxProducts = window.innerWidth <= 768 ? 6 : 12;
  ...
  return (
      <div className="p-4 rounded-md font-sans md:bg-white">
        ...
        <div className="flex justify-center mb-8">
          ...
          <button aria-label="Featured products"
          ...
          <button aria-label="Latest products"
          ...
          <button aria-label="Bestseller products"
