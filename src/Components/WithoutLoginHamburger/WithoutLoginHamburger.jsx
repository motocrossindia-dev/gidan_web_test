              ...
              >
                ...
                <div className="p-5 border-b border-gray-100 bg-gray-50">
                  <div className="flex justify-between items-center mb-4">
                    ...
                    <button aria-label="Close" onClick={() => setIsOpen(false)} className="text-gray-600 hover:text-red-500">
        ...
        {isLogoutDialogOpen && (
            <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-[1100]">
              <div className="bg-white p-6 rounded-lg shadow-lg text-center md:w-96 w-80">
                ...
                <div className="mb-4">
                  <img src={LogoutGif} alt="Logout" loading="eager" className="mx-auto w-40" width="150" height="50" style={{ aspectRatio: '3/1' }} />
                </div>
