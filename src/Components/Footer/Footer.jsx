...
if (isMobile) {
  ...
  <a
    href="https://www.facebook.com/biotechmaali"
    target="_blank"
  ...
  <a
    href="https://www.instagram.com/biotechmaali/"
    target="_blank"
    rel="noopener noreferrer"
    className="text-black hover:text-green-500"
  >
  ...
  <a
    href="https://www.linkedin.com/company/biotechmaali/"
    target="_blank"
    rel="noopener noreferrer"
    className="text-black hover:text-green-500"
  >
  ...
  <a
    href="https://www.youtube.com/@biotechmaali"
    target="_blank"
    rel="noopener noreferrer"
    className="text-black hover:text-green-500"
  >
