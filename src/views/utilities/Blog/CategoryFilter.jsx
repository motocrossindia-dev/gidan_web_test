...
const _DownloadApp = typeof __DownloadApp === 'string' ? __DownloadApp : __DownloadApp?.src || __DownloadApp;
const DownloadApp = typeof _DownloadApp === 'string' ? _DownloadApp : _DownloadApp?.src || _DownloadApp;
