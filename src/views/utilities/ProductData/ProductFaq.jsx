  ...
  return (
    <>
      ...
      <div className="max-w-4xl mx-auto p-6 bg-white rounded-lg">
        <h2 className="text-2xl font-bold mb-4 text-center">Frequently Asked Questions (FAQs)</h2>

        {/* Question 1 */}
        <section className="mb-6">
          <h3 className="text-xl font-semibold mb-2">1. How are the plants packaged for shipping?</h3>
          <p>
        ...
        {/* Question 2 */}
        <section className="mb-6">
          <h3 className="text-xl font-semibold mb-2">2. Will my plant look exactly like the picture?</h3>
          <p>
        ...
        {/* Question 3 */}
        <section className="mb-6">
          <h3 className="text-xl font-semibold mb-2">3. What if my plant arrives damaged?</h3>
          <p>
        ...
        {/* Question 4 */}
        <section className="mb-6">
          <h3 className="text-xl font-semibold mb-2">4. How do I care for my plant once it arrives?</h3>
          <p>
        ...
        {/* Question 5 */}
        <section className="mb-6">
          <h3 className="text-xl font-semibold mb-2">5. Do you ship all over India?</h3>
          <p>
        ...
        {/* Question 6 */}
        <section className="mb-6">
          <h3 className="text-xl font-semibold mb-2">6. Can I cancel or modify my order?</h3>
          <p>
        ...
        {/* Question 7 */}
        <section className="mb-6">
          <h3 className="text-xl font-semibold mb-2">7. What types of plants do you sell?</h3>
          <p>
        ...
        {/* Question 8 */}
        <section className="mb-6">
          <h3 className="text-xl font-semibold mb-2">8. Can I gift plants to someone?</h3>
          <p>
