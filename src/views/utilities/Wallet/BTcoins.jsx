    ...
    <>
      ...
      <div className="flex justify-center sm:justify-start px-4 sm:px-6 bg-site-bg min-h-screen w-full mt-2">
        <div className="w-full sm:w-full md:w-4/5 lg:w-full xl:w-full h-auto bg-white shadow-lg p-4 sm:p-6 rounded-lg">
          ...
          <div className="bg-gradient-to-r from-green-50 to-emerald-50 p-4 rounded-lg mb-6">
            ...
            <div className="flex justify-between items-center mt-4">
              <button
                ...
                className="text-md font-semibold text-lime-600 self-end flex items-center gap-2 bg-transparent border-none p-0 cursor-pointer hover:underline"
              >
                <History size={18} />
          ...
          {/* Earn Coins Section */}
          <div className="mb-6">
            <h2 className="text-lg font-semibold mb-4">Ways to Earn GD Coins</h2>
            ...
            {[
              {
                ...
                a: "You can earn GD Coins by referring friends (100 coins per referral) and making purchases (1 coin per ₹10 spent)."
              },
              {
                q: "When do my GD Coins expire?",
                a: "GD Coins are valid for 12 months from the date they are earned."
              },
              {
                q: "How can I redeem my GD Coins?",
                a: "You can redeem your coins for discounts on plant purchases. Different coin amounts unlock different discount values."
              },
              {
                q: "Can I transfer my GD Coins to someone else?",
                a: "No, GD Coins are non-transferable and can only be used by the account holder who earned them."
              }
            ].map((faq, idx) => (
          ...
          <div className="px-2 sm:px-4 py-6">
            ...
            <ul className="list-decimal list-inside space-y-4">
              <li>GD Coins are reward points that can be earned and redeemed on Gidan's platform.</li>
              ...
              <li>Gidan reserves the right to modify or terminate the GD Coins program at any time.</li>
