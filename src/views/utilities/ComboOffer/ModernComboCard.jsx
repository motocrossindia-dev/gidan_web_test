    ...
    <div className="w-full group relative bg-white rounded-2xl border border-transparent hover:border-gray-200 hover:shadow-lg hover:bg-[#CFFFBE] transition-all duration-300 overflow-hidden flex flex-col">
      ...
      <div className="w-full flex flex-col items-center px-3 pb-3 pt-3 flex-1">
        ...
        <div className="flex items-center gap-2 mb-1">
          <span className="text-sm sm:text-lg font-bold text-[#15803D]">
        ...
        {offer?.total_price && offer?.final_price && offer?.total_price > offer?.final_price && (
          <span className="text-[9px] sm:text-[10px] font-bold text-[#15803D] bg-green-100 px-2 py-0.5 rounded-full border border-green-200 mb-2">
        ...
        <button
          className="w-full bg-[#15803D] text-white py-1.5 sm:py-2 px-3 rounded-xl hover:bg-[#15803D]/90 transition-all duration-300 flex items-center justify-center mt-auto pt-2 font-bold text-xs sm:text-sm shadow-md opacity-0 group-hover:opacity-100"
