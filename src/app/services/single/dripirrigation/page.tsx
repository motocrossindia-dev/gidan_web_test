...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Services - Single - Dripirrigation | Gidan Plants",
    description: "Shop and explore services - single - dripirrigation at Gidan, India trusted online plant and gardening store.",
    url: "https://gidanbackendtest.mymotokart.in/services/single/dripirrigation",
  ...
  alternates: { canonical: "https://gidanbackendtest.mymotokart.in/services/single/dripirrigation" },
